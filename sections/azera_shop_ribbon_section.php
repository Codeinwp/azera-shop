						...
						<?php
							...
							if( !empty($azera_shop_button_text) ){
								if( empty($azera_shop_button_link) ){
									echo '<button class="btn btn-primary standard-button paralax_one_only_customizer" type="button" data-toggle="modal" data-target="#stamp-modal"><span class="screen-reader-text">'.esc_html__('Ribbon button label:','azera-shop').$azera_shop_button_text.'</span>'.$azera_shop_button_text.'</button>';
								} else {
...
<?php
		...
		if( isset( $wp_customize ) ) {
			if(!empty($ribbon_background)){
				echo '<section class="call-to-action ribbon-wrap paralax_one_only_customizer" id="ribbon" style="background-image:url('.$ribbon_background.');" role="region" aria-label="'.esc_html__('Ribbon','azera-shop').'">';
			} else {
				echo '<section class="call-to-action ribbon-wrap paralax_one_only_customizer" id="ribbon" role="region" aria-label="'.esc_html__('Ribbon','azera-shop').'">';
			}
?>
				<div class="section-overlay-layer">
					<div class="container">
