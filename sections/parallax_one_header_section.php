...
<?php
	...
	$parallax_one_header_title = get_theme_mod('parallax_one_header_title',esc_html__('AZERA SHOP','azera-shop'));
	$parallax_one_header_subtitle = get_theme_mod('parallax_one_header_subtitle',esc_html__('From the creators of the popular Zerif Lite meet the new ecommerce theme','azera-shop'));
	$parallax_one_header_button_text = get_theme_mod('parallax_one_header_button_text',esc_html__('GET STARTED','azera-shop'));
							...
							<?php
								if( !empty($parallax_one_header_button_text) ){
									if( empty($parallax_one_header_button_link) ){
										echo '<button id="inpage_scroll_btn" class="btn btn-primary standard-button inpage-scroll"><span class="screen-reader-text">'.esc_html__('Header button label:','azera-shop').$parallax_one_header_button_text.'</span>'.$parallax_one_header_button_text.'</button>';
									} else {
										if(strpos($parallax_one_header_button_link, '#') === 0) {
											echo '<button id="inpage_scroll_btn" class="btn btn-primary standard-button inpage-scroll" data-anchor="'.$parallax_one_header_button_link.'"><span class="screen-reader-text">'.esc_html__('Header button label:','azera-shop').$parallax_one_header_button_text.'</span>'.$parallax_one_header_button_text.'</button>';
										} else {
											echo '<button id="inpage_scroll_btn" class="btn btn-primary standard-button inpage-scroll" onClick="parent.location=\''.esc_url($parallax_one_header_button_link).'\'"><span class="screen-reader-text">'.esc_html__('Header button label:','azera-shop').$parallax_one_header_button_text.'</span>'.$parallax_one_header_button_text.'</button>';
										}
									}
								} elseif ( isset( $wp_customize )   ) {
