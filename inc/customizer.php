...
function azera_shop_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting(
		'azera_shop_front_page_instructions',
		array(
			'sanitize_callback' => 'azera_shop_sanitize_text',
		)
	);
	...
	$wp_customize->add_panel(
		'azera_shop_front_page_sections',
		array(
	...
	$wp_customize->add_section(
		'azera_shop_logos_settings_section',
		array(
	...
	/* Header subtitle */
	$wp_customize->add_setting(
		'azera_shop_shop_section_subtitle',
		array(
	...
	$wp_customize->add_control(
		new WP_Customize_Image_Control(
			$wp_customize, 'azera_shop_ribbon_background',
			array(
	...
	$wp_customize->add_setting(
		'azera_shop_contact_info_content',
		array(
			'sanitize_callback' => 'azera_shop_sanitize_repeater',
			'default'           => $default,
		)
	...
	/* Map ShortCode  */
	$wp_customize->add_setting(
		'azera_shop_frontpage_map_shortcode',
		array(
			'default'           => '',
			'sanitize_callback' => 'azera_shop_sanitize_text',
		)
	...
	/* Contact Form  */
	$wp_customize->add_setting(
		'azera_shop_contact_form_shortcode',
		array(
			'default'           => '',
			'sanitize_callback' => 'azera_shop_sanitize_text',
		)
	...
	/* Map ShortCode  */
	$wp_customize->add_setting(
		'azera_shop_contact_map_shortcode',
		array(
			'default'           => '',
			'sanitize_callback' => 'azera_shop_sanitize_text',
		)
	...
	$wp_customize->add_section(
		'azera_shop_blog_header_section',
		array(
