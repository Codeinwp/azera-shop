...
function parallax_one_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section( 'parallax_one_sections_order' , array(
		'title'       => __( 'Sections management', 'azera-shop' ),
		'priority' => 20
	));
	...
	$wp_customize->add_control( new Parallax_One_Message( $wp_customize, 'parallax_one_sections_management',
		array(
			'label'    => __( 'Sections management', 'azera-shop' ),
			'section' => 'parallax_one_sections_order',
			'priority' => 1,
			'parallax_message' => __( 'Check out the <a href="http://themeisle.com/plugins/parallax-one-plus/">PRO version</a> for full control over the frontpage SECTIONS ORDER!', 'azera-shop' )
	   )
	));
	...
	$wp_customize->add_section( 'parallax_one_features_ribbon_section' , array(
		'title'       => esc_html__( 'Features ribbon section', 'azera-shop' ),
		'priority'    => 46,
	));
	...
	$wp_customize->add_control( new Parallax_One_Message( $wp_customize, 'parallax_one_features_ribbon_text',
		array(
			'label'    => __( 'Features ribbon', 'azera-shop' ),
			'section' => 'parallax_one_features_ribbon_section',
			'priority' => 1,
			'parallax_message' => __( 'Check out the <a href="http://themeisle.com/plugins/parallax-one-plus/">PRO version</a> for full control over the NEW FEATURES RIBBON SECTION!', 'azera-shop' )
	   )
	));
	...
	$wp_customize->add_control( new Parallax_One_Message( $wp_customize, 'parallax_one_shop_text',
		array(
			'label'    => __( 'Shop', 'azera-shop' ),
			'section' => 'parallax_one_shop_section',
			'priority' => 1,
			'parallax_message' => __( 'Check out the <a href="http://themeisle.com/plugins/parallax-one-plus/">PRO version</a> for full control over the NEW SHOP SECTION!', 'azera-shop' )
	   )
	));
	...
	$wp_customize->add_section( 'parallax_one_portfolio_section' , array(
		'title'       => esc_html__( 'Portfolio section', 'azera-shop' ),
		'priority'    => 48,
	));
	...
	$wp_customize->add_control( new Parallax_One_Message( $wp_customize, 'parallax_one_portfolio_text',
		array(
			'label'    => __( 'Portfolio', 'azera-shop' ),
			'section' => 'parallax_one_portfolio_section',
			'priority' => 1,
			'parallax_message' => __( 'Check out the <a href="http://themeisle.com/plugins/parallax-one-plus/">PRO version</a> for full control over the NEW PORTFOLIO SECTION!', 'azera-shop' )
	   )
	));
	...
	$wp_customize->add_control( new Parallax_One_Message( $wp_customize, 'parallax_one_shortcodes_text',
		array(
			'label'    => __( 'Shortcodes', 'azera-shop' ),
			'section' => 'parallax_one_shortcodes_section',
			'priority' => 1,
			'parallax_message' => __( 'Check out the <a href="http://themeisle.com/plugins/parallax-one-plus/">PRO version</a> for full control over the NEW SHORTCODES SECTION!', 'azera-shop' )
	   )
	));	
	...
	$wp_customize->add_section( 'parallax_one_new_features' , array(
		'title'       => esc_html__( 'New Features', 'azera-shop' ),
		'priority'    => 76,
	));
	...
	$wp_customize->add_control( new Parallax_One_Message( $wp_customize, 'parallax_one_new_layout',
		array(
			'label'    => __( 'Header Layout', 'azera-shop' ),
			'section' => 'parallax_one_new_features',
			'priority' => 1,
			'parallax_message' => __( 'Check out the <a href="http://themeisle.com/plugins/parallax-one-plus/">PRO version</a> for full control over the HEADER\'S LAYOUT SECTION!', 'azera-shop' )
	   )
	));	
	...
	$wp_customize->add_control( new Parallax_One_Message( $wp_customize, 'parallax_one_new_color',
		array(
			'label'    => __( 'Color scheme', 'azera-shop' ),
			'section' => 'parallax_one_new_features',
			'priority' => 2,
			'parallax_message' => __( 'Check out the <a href="http://themeisle.com/plugins/parallax-one-plus/">PRO version</a> for full control over the COLOR SCHEME!', 'azera-shop' )
	   )
	));
	...
	$wp_customize->add_control( new Parallax_One_Message( $wp_customize, 'parallax_one_new_preloader',
		array(
			'label'    => __( 'Preloader', 'azera-shop' ),
			'section' => 'parallax_one_new_features',
			'priority' => 2,
			'parallax_message' => __( 'Check out the <a href="http://themeisle.com/plugins/parallax-one-plus/">PRO version</a> for full control over the PRELOADER IMAGE!', 'azera-shop' )
	   )
	));	
