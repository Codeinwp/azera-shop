...
class azera_shop_Welcome {
	...
	public function azera_shop_welcome_admin_notice() {
		?>
			<div class="updated notice is-dismissible">
				<p><?php echo sprintf( esc_html__( 'Welcome! Thank you for choosing Azera Shop! To fully take advantage of the best our theme can offer please make sure you visit our %1$swelcome page%2$s.', 'azera-shop' ), '<a href="' . esc_url( admin_url( 'themes.php?page=azera-shop-welcome' ) ) . '">', '</a>' ); ?></p>
	...
	public function azera_shop_welcome_style_and_scripts( $hook_suffix ) {
		...
		if ( 'appearance_page_azera-shop-welcome' == $hook_suffix ) {
			...
			wp_localize_script(
				'azera-shop-welcome-screen-js', 'azeraShopWelcomeScreenObject', array(
	...
	public function azera_shop_welcome_scripts_for_customizer() {
		...
		wp_localize_script(
			'azera-shop-welcome-screen-customizer-js', 'azeraShopWelcomeScreenCustomizerObject', array(
				'nr_actions_required' => $nr_actions_required,
