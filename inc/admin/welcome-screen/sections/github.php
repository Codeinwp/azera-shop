...
<div id="github" class="azera-shop-tab-pane">

	<h1><?php esc_html_e( 'How can I contribute?', 'azera-shop' ); ?></h1>
	...
	<div class="azera-shop-tab-pane-half">
		...
		<p><strong><?php esc_html_e( 'Are you a polyglot? Want to translate Azera Shop into your own language?', 'azera-shop' ); ?></strong></p>

		<p><?php esc_html_e( 'Get involved at WordPress.org.', 'azera-shop' ); ?></p>

		<p>
			<a href="<?php echo esc_url( 'https://translate.wordpress.org/projects/wp-themes/azera-shop/' ); ?>" class="translate-button button button-primary"><?php _e( 'Translate Azera Shop', 'azera-shop' ); ?></a>
		</p>
