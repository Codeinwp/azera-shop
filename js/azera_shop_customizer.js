...
function azera_shop_refresh_general_control_values(){
	jQuery( '.azera_shop_general_control_repeater' ).each(
		function(){
			var values = [];
			var th = jQuery( this );
			th.find( '.azera_shop_general_control_repeater_container' ).each(
				function(){
...
jQuery( document ).ready(
	function(){
		jQuery( '#customize-theme-controls' ).on(
			'click','.azera-shop-customize-control-title',function(){
		...
		jQuery( '#customize-theme-controls' ).on(
			'change','.azera_shop_image_choice',function() {
		...
		jQuery( '#customize-theme-controls' ).on(
			'change', '.dd-selected-value',function(){
				azera_shop_refresh_general_control_values();
				return false;
			}
		);

		jQuery( '.azera_shop_general_control_new_field' ).on(
			'click',function(){
		...
		jQuery( '#customize-theme-controls' ).on(
			'click', '.azera_shop_general_control_remove_field',function(){
		...
		jQuery( '#customize-theme-controls' ).on(
			'keyup', '.azera_shop_title_control',function(){
				azera_shop_refresh_general_control_values();
			}
		);

		jQuery( '#customize-theme-controls' ).on(
			'keyup', '.azera_shop_subtitle_control',function(){
				azera_shop_refresh_general_control_values();
			}
		);

		jQuery( '#customize-theme-controls' ).on(
			'keyup', '.azera_shop_shortcode_control',function(){
				azera_shop_refresh_general_control_values();
			}
		);

		jQuery( '#customize-theme-controls' ).on(
			'keyup', '.azera_shop_text_control',function(){
				azera_shop_refresh_general_control_values();
			}
		);

		jQuery( '#customize-theme-controls' ).on(
			'keyup', '.azera_shop_link_control',function(){
				azera_shop_refresh_general_control_values();
			}
		);
...
jQuery( document ).ready(
	function() {
		...
		jQuery( document ).on(
			'change', '.azera_shop_cat_select', function () {
...
jQuery( document ).ready(
	function () {
		...
		jQuery( document ).on(
			'click', '.azera-shop-image-picker li', function () {
				var th = jQuery( this ).parent().parent();
