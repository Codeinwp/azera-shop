...
( function( $ ) {
	...
	****************************************/
	...
	// Show Header Logo
	wp.customize(
		'azera_shop_header_logo', function( value ){
			value.bind(
				function( to ) {
					if ( to !== '' ) {
	...
	// Title
	wp.customize(
		'azera_shop_header_title', function(value) {
	...
	// Subtitle
	wp.customize(
		'azera_shop_header_subtitle', function(value) {
	...
	// Button text
	wp.customize(
		'azera_shop_header_button_text', function(value) {
	...
	// Button link
	wp.customize(
		'azera_shop_header_button_link', function(value) {
	...
	*******************************************************/
	...
	// Title
	wp.customize(
		'azera_shop_our_services_title', function(value) {
	...
	// Subtitle
	wp.customize(
		'azera_shop_our_services_subtitle', function(value) {
	...
	*******************************************************/
	// Title
	wp.customize(
		'azera_shop_happy_customers_title', function(value) {
	...
	// Subtitle
	wp.customize(
		'azera_shop_happy_customers_subtitle', function(value) {
	...
	*******************************************************/
	...
	wp.customize(
		'azera_shop_ribbon_background', function( value ) {
			value.bind(
				function( to ) {
	...
	// Title
	wp.customize(
		'azera_shop_ribbon_title', function(value) {
	...
	// Button text
	wp.customize(
		'azera_shop_button_text', function(value) {
	...
	// Button link
	wp.customize(
		'azera_shop_button_link', function(value) {
	...
	// Title
	wp.customize(
		'azera_shop_shop_section_title', function(value) {
	...
	// Subtitle
	wp.customize(
		'azera_shop_shop_section_subtitle', function(value) {
	...
	/* Blog header */
	wp.customize(
		'azera_shop_blog_header_title', function(value) {
			value.bind(
				function( to ) {
	...
	wp.customize(
		'azera_shop_blog_header_subtitle', function(value) {
			value.bind(
				function( to ) {
	...
	wp.customize(
		'azera_shop_blog_header_image', function(value) {
			value.bind(
				function( to ) {
	...
	****************************************/
	// Copyright
	wp.customize(
		'azera_shop_copyright', function(value) {
			value.bind(
				function( to ) {
					if ( to !== '' ) {
